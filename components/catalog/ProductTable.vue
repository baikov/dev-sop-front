...
const offset = computed(() => (page.value - 1) * 50)
...
const endpoint = computed(
  () => `${config.public.apiUrl}/products/?category=${slug}&sort=${djangoSort.value}&limit=${productListParams.value.limit}&offset=${offset.value}${filters.value}`,
)
